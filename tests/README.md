...
| `netfilter/` | les cas **P-01 … P-08** sur le gabarit partagé (**root + netns**) | 4 | annexe 3 §2.2, §3.2 et §8 |
| `agent-passerelle/` | les cas **G-01 … G-11** — la boucle contre le mock : diff, 401, ipset | 4 | annexe 3 §4 |
